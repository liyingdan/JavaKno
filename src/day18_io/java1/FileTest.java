...
public File[] listFiles() ：获取指定目录下的所有文件或者文件目录的File数组
    ...
    public void test2(){
        ...
        System.out.println(file1.getAbsolutePath()); //E:\Idea的项目呀\JavaKno\hello.txt
        System.out.println(file1.getPath());//hello.txt
        System.out.println(file1.getName()); //hello.txt
        System.out.println(file1.getParent()); //null 相对路径看不到上层路径
        System.out.println(file1.length()); //0 因为项目里还没有hello.txt的文件
