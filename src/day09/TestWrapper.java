...
public class TestWrapper {
    ...
    public void test2(){
        ...
        Integer i2 = i1;
        String str2 = String.valueOf(i2); //方法2
    ...
    public void test1(){
        ...
        b1 = new Boolean("truea"); //对于Boolean来讲,当形参是"true"返回true，除此之外都返回false。（不会报异常）
        System.out.println(b1);

        //Order o = new Order();
        //System.out.println("$ "+o.b);//null  引用类型的初始化值都是null
